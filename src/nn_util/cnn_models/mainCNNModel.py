...
class MainCNNModel(pl.LightningModule):
    ...
    def __init__(self, lr=0.001, momentum=0.9, beta_1=0.9, beta_2=0.999, window_size=30, features=24,
        ...
        # Architecture
        if default:
            self.layer1_conv = torch.nn.Conv1d(in_channels=features, out_channels=40, kernel_size=5)
            self.layer1_bn = torch.nn.BatchNorm2d(40)

            self.layer2_conv = torch.nn.Conv1d(in_channels=40, out_channels=40, kernel_size=5)
